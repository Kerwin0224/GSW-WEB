...
export default async function AdminDashboard() {
  ...
  const { users, classes, readyCaps, presets, mcp, exports } = result.data as { users: Array<{ id: string; display_name: string; email: string | null; role: string; status: string }>; classes: unknown[]; readyCaps: Set<string>; presets: unknown[]; mcp: unknown[]; exports: unknown[] };
