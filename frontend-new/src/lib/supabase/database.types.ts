...
export interface Database {
  public: {
    Tables: {
      profiles: {
        Row: { id: string; login_id: string | null; display_name: string; email: string | null; role: AppRole; status: 'active' | 'disabled'; created_at: string; updated_at: string };
        Insert: { id: string; login_id?: string | null; display_name: string; email?: string | null; role: AppRole; status?: 'active' | 'disabled' };
      ...
      mcp_servers: {
        Row: { id: string; name: string; endpoint: string; health_status: string; enabled_tools: Json; allowed_roles: AppRole[]; is_enabled: boolean; created_by: string | null; created_at: string; updated_at: string };
        Insert: { id?: string; name: string; endpoint: string; health_status?: string; enabled_tools?: Json; allowed_roles?: AppRole[]; is_enabled?: boolean; created_by?: string | null };
    ...
    Functions: {
      ...
      find_login_email: { Args: { p_login_id: string }; Returns: { email: string }[] };
